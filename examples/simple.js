...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src___ = __webpack_require__(19);
    ...
    ['borderColor'].forEach(function (cssName) {
        ...
        if (name === cssName) {
            ...
            if (values.length === 4) {
                ...
                processed = (_processed = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderTopColor', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderRightColor', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderBottomColor', values[2]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderLeftColor', values[3]), _processed);
            } else if (values.length === 3) {
                var _processed2;

                processed = (_processed2 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderTopColor', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderLeftColor', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderRightColor', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderBottomColor', values[2]), _processed2);
            } else if (values.length === 2) {
                var _processed3;

                processed = (_processed3 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderTopColor', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderBottomColor', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderLeftColor', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderRightColor', values[1]), _processed3);
            } else {
    ...
    ['borderRadius'].forEach(function (cssName) {
        ...
        if (name === cssName) {
            ...
            if (values.length === 4) {
                ...
                processed = (_processed = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderTopLeftRadius', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderTopRightRadius', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderBottomRightRadius', values[2]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderBottomLeftRadius', values[3]), _processed);
            } else if (values.length === 3) {
                var _processed2;

                processed = (_processed2 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderTopLeftRadius', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderTopRightRadius', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderBottomLeftRadius', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderBottomRightRadius', values[2]), _processed2);
            } else if (values.length === 2) {
                var _processed3;

                processed = (_processed3 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderTopLeftRadius', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderBottomRightRadius', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderTopRightRadius', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderBottomLeftRadius', values[1]), _processed3);
            } else {
                processed = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, name, values[0]);
            }
        }
    ...
    ['borderWidth'].forEach(function (cssName) {
        ...
        if (name === cssName) {
            ...
            if (values.length === 4) {
                ...
                processed = (_processed = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderTopWidth', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderRightWidth', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderBottomWidth', values[2]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'borderLeftWidth', values[3]), _processed);
            } else if (values.length === 3) {
                var _processed2;

                processed = (_processed2 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderTopWidth', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderLeftWidth', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderRightWidth', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'borderBottomWidth', values[2]), _processed2);
            } else if (values.length === 2) {
                var _processed3;

                processed = (_processed3 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderTopWidth', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderBottomWidth', values[0]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderLeftWidth', values[1]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed3, 'borderRightWidth', values[1]), _processed3);
            } else {
                processed = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, name, values[0]);
            }
        }
    ...
    ['flex'].forEach(function (cssName) {
        if (name === cssName) {
            ...
            if (values.length === 3) {
                ...
                processed = (_processed = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'flexGrow', parseFloat(values[0])), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'flexShrink', parseFloat(values[1])), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed, 'flexBasis', parseFloat(values[2])), _processed);
            } else if (values.length === 2) {
                var _processed2;

                processed = (_processed2 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'flexGrow', parseFloat(values[0])), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_processed2, 'flexShrink', parseFloat(values[1])), _processed2);
            } else if (values.length === 1 && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["c" /* isNumber */])(values[0])) {
                processed = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, name, parseFloat(values[0]));
            } else {
                warning(name, value);
            }
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__borderRadius__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__borderColor__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__borderWidth__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__display__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__paddingMargin__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__flex__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__transformers_index__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__filters_index__ = __webpack_require__(15);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__background__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__boxShadow__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fontFamily__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__textShadow__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__transform__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__textDecoration__ = __webpack_require__(24);
